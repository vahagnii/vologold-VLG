...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Vologold " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x02294b6d, 0x5745fc25, 0xea294b6d, 0x6a294b6d, 0xd31fa8c0, 0x9a1fa8c0, 0xbb1fa8c0
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Vologold is probably already running."), addrBind.ToString().c_str());
        else
